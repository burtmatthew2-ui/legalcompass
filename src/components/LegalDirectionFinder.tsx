      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card className="p-8">
            ...
            {categories.map((cat) => {
              ...
              return (
                <Button
                  ...
                  className="h-auto py-6 flex flex-col items-center gap-3 hover:border-primary transition-all"
          ...
          <p className="text-sm text-slate-500 text-center mt-6">
            Choose a category above to get started with personalized guidance
          </p>
        </Card>
      </div>
    </section>
