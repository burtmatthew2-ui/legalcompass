...
export const MissionStatement = () => {
  return (
    <section className="py-8 md:py-16 px-4 md:px-6 bg-gradient-to-r from-primary/5 to-blue-50">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg md:text-xl text-slate-700 leading-relaxed mb-3 md:mb-4 px-4">
